...
\begin{table}[!ht]
\begin{center}
\caption{{\rmfamily{Commonly used radial basis functions, where $\varepsilon\in \mathbb{R}^+$ is the shape parameter for the infinitely smooth RBFs, and $q\in\{2m-1,\ m \in \mathbb{N}\}$ is the degree of the polyharmonic spline as a piecewise smooth RBF.}}}
